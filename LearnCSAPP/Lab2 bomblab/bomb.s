...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp                       //others
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp                 // expend stack 40 bits
  400f02:	48 89 e6             	mov    %rsp,%rsi                  // %rsi = %rsp
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  // get 6 numbers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                // (%rsp) == 1? continue : explode_bomb
  400f0e:	74 20                	je     400f30 <phase_2+0x34> 
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax            // %rax = (%rbx) - 4 =  (%rsp + 4) - 4
  400f1a:	01 c0                	add    %eax,%eax                  // %rax = 2*rax
  400f1c:	39 03                	cmp    %eax,(%rbx)                
  400f1e:	74 05                	je     400f25 <phase_2+0x29>      // (%rbx)==2*%rsp?continue:explode_bomb
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>      
  400f25:	48 83 c3 04          	add    $0x4,%rbx                  // %rbx += 4
  400f29:	48 39 eb             	cmp    %rbp,%rbx                 
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>      // %rbx != %rbp ? continue : end
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> 
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx             // %rbx = (%rsp + 4)
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp            // %rbp = (%rsp + 24)
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>      
  400f3c:	48 83 c4 28          	add    $0x28,%rsp                 // others
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   

0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp                   // epand 24 bits on stack 
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx               // %rcx = (12 + %rsp)
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx               // %rdx = (8 + %rsp)
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi               // %rsi = "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax                    // %rax = 0
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> 
  400f60:	83 f8 01             	cmp    $0x1,%eax                    
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>        // sscanf_number > 1 ? continue : BOOM
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>        // !BOOM!
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)               
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>        // (8 + %rsp) > 7 ? BOOM : continue
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax               // %rax = (8 + %rsp)
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)           // switch case (0x402470 + 8 * (%rax))
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                   // case 0: %rax = 207
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax                  // case 2: %rax = 707
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax                  // case 3: %rax = 256
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax                  // case 4: %rax = 389
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                   // case 5: %rax = 206
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax                  // case 6: %rax = 682
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                  // case 7: %rax = 327
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>         // !BOOM!
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax                   // case 1: %rax = 311
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>         // !BOOM!
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax                    // %rax = 14
  400fd4:	29 f0                	sub    %esi,%eax                    // %rax = 14 - %rsi = 14
  400fd6:	89 c1                	mov    %eax,%ecx                    // %rcx = %rax = 14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                   // %rcx = %rcx >> 31 (positive or negtive)
  400fdb:	01 c8                	add    %ecx,%eax                    // %rax = %rcx
  400fdd:	d1 f8                	sar    %eax                         // %rax == %rax >> 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx           // %rcx = %rax + (%rsi)
  400fe2:	39 f9                	cmp    %edi,%ecx                    // (%rsi + 8) >= %rcx ? 
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx              // %rdx = %rcx - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax                    // end
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                    // rax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx                    // %rcx >= (%rsi + 8) ?
  400ff9:	7d 0c                	jge    401007 <func4+0x39>
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi               // %rsi = %rci + 1
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax                      // sscanf_number != 2 ? BOOM : continue
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                 // (%rsp + 8) <= 14 ? continue : BOOM
  ...
  401048:	e8 81 ff ff ff       	callq  400fce <func4>                 // fun( (%rsp + 8), 0,14 )
  40104d:	85 c0                	test   %eax,%eax                      
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                 // (%rsp + 12) == 0 ? end : BOOM
...
0000000000401062 <phase_5>:
  ...
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)              // Store the canary
  401078:	31 c0                	xor    %eax,%eax                    // %rax = 0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>       // %rax = string_length
  40107f:	83 f8 06             	cmp    $0x6,%eax                    // %rax == 6 ? continue : BOOM
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>

  // IMPORATANT PART BEGIN
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx           // %rcx = %rax + %rbx
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                  // %rdx = %cl
  401096:	83 e2 0f             	and    $0xf,%edx                    // %rdx = %rdx & 1111
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx          // %rdx = "maduiersnfotvbyl"
                                                                               0123456789ABCDEF
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)        // (%rsp + %rax) = %rdl 
  ...
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                // %rsi = "flyers"
...
00000000004010f4 <phase_6>:
  ...
  401121:	76 05                	jbe    401128 <phase_6+0x34>      //number1 <= 6
  ...
  401135:	48 63 c3             	movslq %ebx,%rax                  // %rax = 1,2
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax         // %rax = number 2,3
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)             // number2 != number1 ? continue : BOOM
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                  // %rbx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                  // %rbx <= 5 ? jump    
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13                  // %r13 += 4 ( = number2  )
  401151:	eb c1                	jmp    401114 <phase_6+0x20>   
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi            // %rsi = (%rsp + 24)
  401158:	4c 89 f0             	mov    %r14,%rax                  // %rax = number1
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                  // %rcx = 7 = %rdx 
  401160:	89 ca                	mov    %ecx,%edx                  // %rdx = %rcx = 7
  401162:	2b 10                	sub    (%rax),%edx                // %rdx -= %rax = 7 - number1
  401164:	89 10                	mov    %edx,(%rax)                // (%rax) = 7 - number1
  401166:	48 83 c0 04          	add    $0x4,%rax                  // %rax = number2                   
  40116a:	48 39 f0             	cmp    %rsi,%rax                  // 11 - number2 != (%rsi) ?
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>      // 
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                  // %rsi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx             // rdx = 
  40117a:	83 c0 01             	add    $0x1,%eax                  // rax += 1
  40117d:	39 c8                	cmp    %ecx,%eax                  // rax != rcx ? jump : continue
  40117f:	75 f5                	jne    401176 <phase_6+0x82>      
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx              // %rdx = 0x4c
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)      // number[2*%rsi/4] + 0x20 = 0xbb
  40118d:	48 83 c6 04          	add    $0x4,%rsi                   // %rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                  // %rsi = 24 ? jump : continue
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx          // %rcx = number[%rsi/4]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                   // %rcx <= 1 ? jump : continue
...
0000000000401204 <fun7>:
  ...
  40120d:	8b 17                	mov    (%rdi),%edx            // %rdx = "$"
  40120f:	39 f2                	cmp    %esi,%edx              // %rdx <= number ? jump
...
0000000000401242 <secret_phase>:
  ...
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>        // strtol(%rax,0,10)
  40125a:	48 89 c3             	mov    %rax,%rbx                  // %rbx = number
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax            // %rax = -0x1(%rax)
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  401265:	76 05                	jbe    40126c <secret_phase+0x2a> // %rax <= 1000
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi                  // %rsi = number
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi             // %rdi = "$"
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>              // fun("$")
  401278:	83 f8 02             	cmp    $0x2,%eax
  40127b:	74 05                	je     401282 <secret_phase+0x40> // %rax == 2
